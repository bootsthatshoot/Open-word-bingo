...
def popup():
    infomenu = tkinter.messagebox.showinfo("Info, Sucka!", "Start with a new game" "\n"
                                           "All main bosses - Old Bitey, Yeti King, Alien Queen, Anubis" "\n"
                                           "Use of shortcuts is allowed once they are unlocked" "\n"
                                           "You may do multiple entries in one run" "\n"
                                           "\n"
                                           "\n"
                                           "-Bootsie"
                                           )
...
list1 = ['All Hell journal entries', 'All Ice Caves journal entries', 'All Jungle journal entries',
         'All Mines journal entries', 'All Temple journal entries', 'Any gem above Mines Entrance door',
         'Full Any% run', 'Get the shield', 'Hell Any%', 'Invigoration', 'Kill Magma Man', 'Kill main bosses',
         'No Gold Hell', 'No Gold Ice Caves', 'No Gold Jungle', 'No Gold Mines', 'No Gold Temple', 'No Gold Worm',
         'No% Ice Caves', 'No% Jungle', 'No% Mines', 'No% Mothership', 'No% Temple', 'No% Worm',
         'Olmec with Ball&Chain', 'Pacifist Hell', 'Pacifist Ice Caves', 'Pacifist Jungle', 'Pacifist Mines',
         'Pacifist Mothership', 'Pacifist Temple', 'Pacifist Worm', 'Sacrifice Shopkeeper', 'Unlock Ice Caves shortcut',
         'Unlock Jungle shortcut', 'Unlock Temple shortcut', 'Visit all areas', 'Whip 3 TNT boxes in one run']
